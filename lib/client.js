window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject('conversation.input.right', () => ctx.slots.register({ name: 'conversation.input.right', id: NS, order: -10, inject: (sessionId) => ({ sessionId, api, scope }) }, Selector))
    ...
    exports.name = NS
    exports.inject = ['slots', 'connection', 'settingsScope', 'remote.session', 'remote.settings']
    exports.apply = apply
