...
**Current release: 0.1.4** — Uses the DSH 0.1.2 standard Slot props contract so the Composer selector renders correctly; Fine-grained Remote APIs remain capability-detected and optional.
